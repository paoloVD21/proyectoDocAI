...
PROMPTS = {
    "Requisitos": lambda texto: (
        ...
        "3. Cada HU siempre debe tener requisito funcional, nunca hagas solo para una sola HU todos los requisitos\n"
        "4. Debe ser atómico (una sola funcionalidad que el sistema permitira hacer al usuario)\n"
        "5. Debe ser medible y verificable\n"
        "6. Debe estar redactado en tercera persona del presente\n"
        "7. Debe ser redacto asi: El sistema debe ....\n"
        "8. El requisito no debe redactarse como si el sistema lo hiciera solo automaticamente\n"
