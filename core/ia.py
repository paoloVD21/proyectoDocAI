...
PROMPTS = {
    "Requisitos": lambda texto: (
        ...
        "3. Debe ser atómico (una sola funcionalidad que el sistema permitira hacer al usuario)\n"
        "4. Debe ser medible y verificable\n"
        "5. Debe estar redactado en tercera persona del presente\n"
        "6. Debe ser redacto asi: El sistema debe ....\n"
        "7. El requisito no debe redactarse como si el sistema lo hiciera solo automaticamente\n"
    ...
    "Diagrama de clases": lambda historias_usuario, requisitos: (
        ...
        "        +cerrarCaja(): void\n"
        "        +anularVenta(): void\n"
        "        +consultarPrecioProducto(codigoProducto: string): float\n"
        "        +generarReporteDiario(): ReporteVenta\n"
        "    }\n"
        "\n"
        "    class Venta {\n"
        "        -idVenta: int\n"
        ...
        "        -descripcion: string\n"
        "        -porcentaje: float\n"
        "        +aplicarDescuento(venta: Venta): void\n"
        "    }\n"
        "\n"
        "    class Cliente {\n"
        "        -idCliente: int\n"
        ...
        "    }\n"
        "\n"
        "    Cajera *-- CajaRegistradora : opera\n"
        "    Cajera *-- Venta : realiza\n"
        "    Venta *-- Producto : contiene\n"
        "    Venta --> Pago : registra\n"
        "    Venta --> Descuento : aplica\n"
        "    Cajera --> Producto : consulta\n"
        "    Cajera --> Cliente : registra\n"
        "    Cajera --> ReporteVenta : genera\n"
        "    Producto \"1\" -- \"1\" ReporteVenta: esReportadoPor\n"
        "    Producto --> Descuento : aplica\n"
        "    Pago --> TipoPago : es\n"
        "    Venta \"1\" -- \"1\" Cliente : pertenece\n"
    ),
